...
COMMON_INSTRUCTIONS = (
    ...
    "Ask only about information whose absence prevents the requested task. Treat explicit task constraints and supplied resources as authoritative; "
    "do not request confirmation of an already supplied AOI, year, or tool-defined valid-pixel convention, or introduce optional masking requirements. "
    "If the requested descriptive product is supported and its required inputs are present, proceed to planning or tool execution. "
    "Distinguish a missing input or definition from missing scientific validation evidence. Clarifying a definition does not supply validation evidence. "
    "Do not propose redefining the requested scientific concept as a convenient product class to bypass missing evidence; "
    "explain the unsupported conclusion while preserving the user's original target. "
